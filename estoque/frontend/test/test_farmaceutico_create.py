...
try:
    ...
    tipo_select.select_by_value("farmaceutico")
    time.sleep(1)

    nome = f"Farmaceutico Create Selenium {random.randint(1000,9999)}"
    driver.find_element(By.NAME, "nome").send_keys(nome)
    driver.find_element(By.NAME, "categoria").send_keys("string")
    driver.find_element(By.NAME, "valor").clear()
    driver.find_element(By.NAME, "valor").send_keys("4")
    driver.find_element(By.NAME, "quantidade").clear()
    driver.find_element(By.NAME, "quantidade").send_keys("4")
    driver.find_element(By.NAME, "tarja").send_keys("string")
    driver.find_element(By.NAME, "composicao").send_keys("string")
    ...
    print(f"\033[92mItem farmacêutico criado com sucesso: {nome}\033[0m")

except Exception as e:
    print("\033[91mErro no teste de criação de item farmacêutico:\033[0m", e)
